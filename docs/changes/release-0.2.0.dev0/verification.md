...
Run34195898952 cleared temporary-root errors and passed98/99 on macOS. Remaining service-symlink fixture created a Linux unit but ran the macOS installer. It now explicitly tests both Linux units and macOS plists, preserving refusal/no-command/victim-content assertions. Runtime code remains unchanged.
