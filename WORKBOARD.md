...
| CAC-003 | Unified installed fleet product with saved plans and native SDLC | Verified preview | 99 regressions, independent review, reproducible wheel, clean install and actual enrolled-host saved apply. Public release and actual macOS receipt remain release gates. |
